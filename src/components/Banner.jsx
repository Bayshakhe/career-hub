...
const Banner = () => {
  return (
    <div style={{maxWidth: '1400px'}} className="grid grid-cols-1 md:grid-cols-2 justify-between items-center mx-auto p-5 pb-0">
      <div>
      ...
      <img className="w-full" src="/hardy.png" alt="Banner image" />
    </div>
  );
};
